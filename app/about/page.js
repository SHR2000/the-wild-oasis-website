...
export default async function Page() {
  ...
  return (
    <>
      {/* Desktop min-1024 */}
      <div className="hidden items-center justify-between gap-x-24 gap-y-32 text-lg min-1024:grid min-1024:grid-cols-2 min-1280:grid-cols-5">
        <div className="min-1280:col-span-3">
        ...
        <div className="min-1280:col-span-2">
          <Image
            src={image1}
        ...
        <div className="relative aspect-square min-1280:col-span-2">
          <Image
            src={image2}
            fill
      ...
      {/* Mobile min-1024:hidden */}
      <div className="flex flex-col items-center justify-between gap-24 text-lg min-1024:hidden">
